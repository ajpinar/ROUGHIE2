function [ header, data ] = loadLog( fileName )
% [ header, data ] = loadLog( fileName )
% INPUT
% fileName - String containing the name of the CSV file. If this is left
%            blank, a UI will pop up to manually select the file.
% OUTPUTS
% header   - A cell array containing the header (text from first row) of 
%            the CSV file.
% data     - A matrix containing the data from the CSV file.
